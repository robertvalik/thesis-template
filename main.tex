...
\usepackage[a4paper, left=3.5cm, top=2.5cm, right=1.5cm, bottom=3.85cm]{geometry} % Margins
\usepackage{graphicx}
...
\newgeometry{left=3.5cm,top=2.5cm,right=2cm,bottom=3.85cm,includehead,includefoot}
