...
\usepackage[a4paper, left=3.5cm, top=2.5cm, right=1.5cm, bottom=3.85cm, includefoot]{geometry} % Margins
\usepackage{graphicx}
...
\fancyhead{}
\fancyfoot{}
\fancyfoot{} % no nombering in the front matter
...
\fancyhead{}
\fancyfoot{}
\fancyfoot[R]{\thepage} % restore numbering
